...
ar1.ProfileConfig(0, 77, 10, 6, 120, 0, 0, 0, 0, 0, 0, 0, 0, 29.982, 0, 100, 10000, 2216755200, 0, 30, 0, 0, 0)
...
function read()
    local file = io.open("D:\\rawData\\test\\msg", "r")
    if not file then
        return nil
    end
...
while true do
    ...
    if msg == "start" then
        if running == false then
            ...
            ar1.CaptureCardConfig_StartRecord("D:\\rawData\\test\\tmp.bin", 1)
            ar1.StartFrame()
            running = true
        else
